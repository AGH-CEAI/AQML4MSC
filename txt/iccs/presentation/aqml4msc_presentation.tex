...
\begin{frame}[t,fragile]{{Multisource Information Fusion (MSIF)}}
	\begin{block}{Multisource Information Fusion (MSIF)}
	...
	\begin{columns}[c,onlytextwidth]
		...
		\begin{itemize}[c]
			\item<1-> Data-level fusion
			\item<2-> Feature-level fusion
			\item<3-> Decision-level fusion
		\end{itemize}
		\column{0.5\textwidth}
		\vspace{1cm} \\
		\includegraphics<1>[width=1.2\textwidth]{fig/Data_Fusion.pdf}
		\includegraphics<2>[width=1.2\textwidth]{fig/Feature_Fusion.pdf}
		\includegraphics<3>[width=1.2\textwidth]{fig/Decision_Fusion.pdf}
	\end{columns}
\end{frame}

\begin{frame}[fragile]{{Quantum Machine Learning (QML)}}
	\begin{itemize}
		\item metody embeddingu
