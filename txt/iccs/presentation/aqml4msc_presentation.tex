...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\part{Introduction}
\begin{frame}[fragile]{{Multisource}}
	\begin{columns}
		\column{0.5\textwidth}
		\begin{itemize}
			\item<1-> Multisource dataset includes different data origin, modality or timing,
			\item<2-> Multisource Information Fusion (MSIF) is a process to aggregate and transform multisource data into useful information to e.g.\ obtain richer and
			      more accurate decision outcomes.   feature-level fusion
			\item<3-> why do we look into this- they are complex tasks, often high dimensional data
		\end{itemize}
		\column{0.5\textwidth}
	\end{columns}
\end{frame}
...
\begin{frame}[fragile]{{Quantum Machine Learning (QML)}}
	\begin{itemize}
		\item what is qml - uses quantum mechanics, sueprposition, entanglment, and machine learning
		\item how is qml - QNN, QSVM
		\item why is qml - possible speed-up
	\end{itemize}
\end{frame}
...
\begin{frame}[fragile]{{Hybrid Quantum-Classical Neural Network}}
	\begin{figure}
		\centering
		\includegraphics[width=1.0\textwidth]{fig/Model_schematic.pdf}
...
\begin{frame}[fragile]{{MNIST}}
	\begin{table}[h]
		...
		\begin{tabular}{lccc}
			...
			\hline
			{MLP}                                     & $0.960 \pm 0.001$                                                   & {75995}                \\
			{PQC$_{\mathrm{manual}}$}                 & $0.886 \pm 0.022$                                                   & {4632}                 \\
