...
results = {
    "mlp_tab": [0.966, 0.966, 0.897, 0.965, 0.965],
    "mlp_images": [0.948, 0.862, 0.897, 0.912, 0.860],
    "mlp_multimodal": [0.931, 0.897, 0.948, 0.947, 0.895],
    "mlp_multimodal_small": [0.931, 0.862, 0.914, 0.860, 0.807],
    "qnn_basic_tab": [0.759, 0.862, 0.862, 0.281, 0.544],
    "qnn_basic_images": [0.741, 0.707, 0.862, 0.772, 0.772],
    "qnn_basic_multimodal": [0.724, 0.845, 0.879, 0.772, 0.842],
    "qnn_basic_multimodal_small": [0.759, 0.759, 0.862, 0.702, 0.807],
    "qnn_strongly_tab": [0.724, 0.707, 0.621, 0.351, 0.719],
    "qnn_strongly_images": [0.759, 0.707, 0.759, 0.737, 0.754],
    "qnn_strongly_multimodal": [0.810, 0.724, 0.741, 0.684, 0.754],
    "qnn_strongly_multimodal_small": [0.724, 0.690, 0.759, 0.737, 0.737],
    "qnn_strongly_probs_tab": [0.828, 0.741, 0.845, 0.316, 0.754],
    "qnn_strongly_probs_images": [0.707, 0.724, 0.741, 0.737, 0.719],
    "qnn_strongly_probs_multimodal": [0.741, 0.776, 0.776, 0.754, 0.754],
    "qnn_strongly_probs_multimodal_small": [0.810, 0.845, 0.845, 0.825, 0.772],
